...
- [Program that allows you to make DJI Pilot 2 compatabile drone flight transects in QGIS](https://github.com/CharlesLehnen/QGIS_KML_to_DJI_Pilot_2)

- [Machine learning workflow to generate huge datasets of training data from YouTube trail cameras](https://github.com/CharlesLehnen/YouTube_Trailcamera_Livestream_Classification_Tool)
...
- [My suggested template for a well organized repo](https://github.com/CharlesLehnen/standard_repository_template)

- [This website, which is edited in Quarto, hosted for free via Github Pages, and rendered to HTML automatically via Github deployment](https://github.com/CharlesLehnen/portfolio)