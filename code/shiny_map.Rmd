...
server <- function(input, output, session) {
  ...
  COTOIcon <- makeIcon(
    iconUrl = "https://github.com/CharlesLehnen/portfolio/tree/main/images/icons/COTO.png",
    iconWidth = 50, iconHeight = 50,
    iconAnchorX = 25, iconAnchorY = 50
  )

  blandingsIcon <- makeIcon(
    iconUrl = "https://github.com/CharlesLehnen/portfolio/tree/main/images/icons/blandings.png",
    iconWidth = 50, iconHeight = 50,
    iconAnchorX = 25, iconAnchorY = 50
  )

  GalapTortIcon <- makeIcon(
    iconUrl = "https://github.com/CharlesLehnen/portfolio/tree/main/images/icons/GalapTort.png",
    iconWidth = 50, iconHeight = 50,
    iconAnchorX = 25, iconAnchorY = 50
  )
